...
import img22_slider from "../img/sam fold.png"
...
const initail = {
    ...
    productLabtab: [
        {
            id: 1,model: 'appel 12" ', ram:8, sdd:256,price: 3000,img: img24_slider, count: 0},
        {
            id: 2,model: 'appel 13" ', ram:16, sdd:256,price: 500,img: img25_slider, count: 0},
        {
            id: 3,model: 'appel 15" ', ram:4, sdd:256,price: 1500,img: img26_slider, count: 0},
        {
            id: 4, model: 'appel 11"', ram: 8, sdd: 256, price: 2000, img: img27_slider, count: 0
        },
          {
            id: 5,model: 'asus 12" ', ram:8, sdd:256,price: 3000,img: img28_slider, count: 0},
        {
            id: 6,model: 'asus 13" ', ram:16, sdd:256,price: 500,img: img29_slider, count: 0},
        {
            id: 7,model: 'asus 15" ', ram:4, sdd:256,price: 1500,img: img30_slider, count: 0},
        {
            id: 8,model: 'asus 11"', ram:8, sdd:256,price: 2000,img: img31_slider, count: 0},
    ],
    productTablet: [ {
            id: 1,model: 'tablet 12" ', ram:8, sdd:256,price: 3000,img: img32_slider, count: 0},
        {
            id: 2,model: 'tablet 13" ', ram:16, sdd:256,price: 500,img: img33_slider, count: 0},
        {
            id: 3,model: 'tablet 15" ', ram:4, sdd:256,price: 1500,img: img34_slider, count: 0},
        {
            id: 4, model: 'tablet 11"', ram: 8, sdd: 256, price: 2000, img: img35_slider, count: 0
        },],
    productFlash: [
        {
            id: 1,model: 'flash " ', ram:32,price: 3000,img: img3_slider, count: 0},
        {
            id: 2,model: 'flash " ', ram:64,price: 500,img: img7_slider, count: 0},
        {
            id: 3,model: 'flash " ', ram:128,price: 1500,img: img8_slider, count: 0},
        {
            id: 4, model: 'flash ', ram: 512, price: 2000, img: img9_slider, count: 0
        },],
    productHard: [
        {
            id: 1,model: 'hdd  ', ram:'1t',price: 3000,img: img4_slider, count: 0},
        {
            id: 2,model: 'hdd  ', ram:'2t',price: 500,img: img15_slider, count: 0},
        
            ],
    productSdd: [
        {
            id: 1,model: 'sdd " ', ram:'1t',price: 3000,img: img6_slider, count: 0},
        {
            id: 2,model: 'sdd " ', ram:512,price: 500,img: img14_slider, count: 0},
        
            ],
    products: [{
            id: 1,product: 'Mobile ',price: 1000,img: img1_slider},
        {
            id: 2,product: 'labtab ',price: 3000,img: img2_slider},
        {
            id: 3,product: 'flash ',price: 500,img: img3_slider},
        {
            id: 4,product: 'hard pc ',price: 1500,img: img4_slider},
        {
            id: 5,product: 'labtab',price: 2000,img: img5_slider},
        {
            id: 6,product: ' hrad sdd',price: 3300,img: img6_slider},
        {
            id: 7,product: 'flash ',price: 1000,img: img7_slider},
        {
            id: 8,product: 'flash ',price: 900,img: img8_slider},
        {
            id: 9,product: 'flash',price: 500,img: img9_slider},
        {
            id: 10,product: 'mobile ',price: 2700,img: img10_slider},
        {
            id: 11,product: 'mobile',price: 3500,img: img11_slider},
        {
            id: 12,product: 'mobile',price: 3100,img: img12_slider},
        {
            id: 13,product: 'mobile',price: 2000,img: img13_slider},
        {
            id: 14,product: ' hrad sdd pc ',price: 3900,img: img14_slider},
        {
            id: 15,product: 'hrad pc ',price: 1000,img: img15_slider},
        {
            id: 16,product: 'tablet',price: 4000,img: img16_slider},
    ],
    counter: 0,
    counter1: 0,
